...
func main() {
	...
	versions.ParseReleaseImages(&releaseImagesArray, Options.ReleaseImages, failOnError)
	...
	if mirrorRegistriesBuilder.IsMirrorRegistriesConfigured() {
		mirrorRegistries, err := mirrorRegistriesBuilder.ExtractLocationMirrorDataFromRegistries()
		if err != nil {
			...
			validations.ParseMirrorRegistries(publicRegistries, mirrorRegistries)
		}
	}
